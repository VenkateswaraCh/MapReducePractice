...
public class JoinSortDepMapper extends Mapper<LongWritable, Text, CompositeKey, Text> {
	...
	protected void map(LongWritable key, Text value,
		...
		String v=null;
		row=line.split(",");
		compositekey.set(new IntWritable(Integer.parseInt(row[0])), new IntWritable(0) );
		v=row[1];
